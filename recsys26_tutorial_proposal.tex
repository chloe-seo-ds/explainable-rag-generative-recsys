...
All code is provided as Jupyter notebooks on Amazon Books, with shared data preparation and evaluation utilities.
\begin{itemize}
    ...
    \item Each notebook supports both local LLM inference (4-bit quantized LLaMA) and API-based alternatives
